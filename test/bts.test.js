...
var {BinarySearchTree} = require('../userCode.js')


// const promise = new Promise((resolve, reject) => {
//   fs.exists(path.resolve(__dirname, '../userCode.txt'), (exists) => {
//      if (exists) {
//         fs.readFile(path.resolve(__dirname, '../userCode.txt'),'utf8', (err, data) => {
//           if(err) {
//             console.log(err);
//             reject(err);
//             } else resolve(data);
